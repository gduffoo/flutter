      ...
      child: Column(
        ...
        children: [
          ...
          CustomProductField(
            ...
            //onChanged: (value) => ref.read(productFormProvider(product).notifier).onTitleChanged(value), //como tienen el mismo parametro se spuede simplificar
            onChanged: ref
                .read(productFormProvider(product).notifier)
                .onTitleChanged, //modo simplicado
          ...
          CustomProductField(
            ...
            onChanged: ref
                .read(productFormProvider(product).notifier)
                .onDescriptionChanged, //modo simplicado
          ),
          CustomProductField(
            isBottomField: true,
            maxLines: 2,
      ...
      child: SegmentedButton(
        ...
        onSelectionChanged: (newSelection) {
          FocusScope.of(context)
              .unfocus(); //si es movil dquita el foco para ocultar teclaro
